...
describe GoodData::Connectors::DownloaderSql::Backend::MsSql do
  ...
  let(:obj) do
    obj = GoodData::Connectors::DownloaderSql::Backend::MsSql.new(metadata)
  ...
  it 'Is defined' do
    expect(GoodData::Connectors::DownloaderSql::Backend::MsSql)
    expect(GoodData::Connectors::DownloaderSql::Backend::MsSql).to be_kind_of(Class)
  end
  ...
  describe '#load_db_fields' do
    it 'Loads fields' do
      ...
      expect(fields.map { |field| field.type.type }).to eq %w(integer string date string string string string string)
    end
  end
